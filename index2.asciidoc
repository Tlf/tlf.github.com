...
It interfaces with the _cwdaemon_ morse code generator and your
sound card for CW/VOICE keying, connects to a number of radios via 
the _Hamlib_ library and has a built-in client for DX cluster connection. 
...
** clone the repository, make changes and send us patches or pull requests.
+
----
