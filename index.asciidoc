...
You can download the source code for the last packaged version (TLF-1.3.1)
http://www.hs-mittweida.de/tb/tlf-1.3.1.tar.gz[here]. 
It must be compiled after unpacking (see below). You will need some other 
